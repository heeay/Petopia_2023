...
CREATE TABLE "TB_EMAIL_AUTH" (
	...
	"EMAIL_AUTH_CODE"	VARCHAR2(10)		NOT NULL,
...
COMMENT ON COLUMN "TB_HOS_RECORDS"."HOS_ILLNESS" IS '질병';
...
COMMENT ON COLUMN "TB_WALK_RECORDS"."FILE_NO" IS '첨부파일번호';
...
CREATE TABLE "TB_PET" (
	...
	"PET_GENDER"	CHAR(1)	DEFAULT 'M' CHECK(PET_GENDER IN ('M','F'))	NULL,
...
COMMENT ON COLUMN "TB_PET"."FILE_NO" IS '첨부파일번호';
...
ALTER TABLE "TB_SUGGESTION" ADD CONSTRAINT "FK_FILE_TO_SUGGESTION_1" FOREIGN KEY (
	"FILE_NO"
)
REFERENCES "TB_FILE" (
	"FILE_NO"
...
VALUES(SEQ_USER_NO.NEXTVAL,'admin@test.com','03AC674216F3E15C761EE1A5E255F067953623C8B388B4459E13F978D7C846F4','admin','01011112222');
INSERT INTO TB_USER(USER_NO,USER_EMAIL,USER_PASS,USER_NICKNAME,USER_PHONE)
VALUES(SEQ_USER_NO.NEXTVAL,'user1@test.com','E6C3DA5B206634D7F3F3586D747FFDB36B5C675757B380C6A5FE5C570C714349','유저1','01011113333');
INSERT INTO TB_USER(USER_NO,USER_EMAIL,USER_PASS,USER_NICKNAME,USER_PHONE)
VALUES(SEQ_USER_NO.NEXTVAL,'user2@test.com','1BA3D16E9881959F8C9A9762854F72C6E6321CDD44358A10A4E939033117EAB9','유저2','01022222222');
INSERT INTO TB_USER(USER_NO,USER_EMAIL,USER_PASS,USER_NICKNAME,USER_PHONE)
VALUES(SEQ_USER_NO.NEXTVAL,'user3@test.com','3ACB59306EF6E660CF832D1D34C4FBA3D88D616F0BB5C2A9E0F82D18EF6FC167','유저3','01033332222');
INSERT INTO TB_USER(USER_NO,USER_EMAIL,USER_PASS,USER_NICKNAME,USER_PHONE)
VALUES(SEQ_USER_NO.NEXTVAL,'user4@test.com','A417B5DC3D06D15D91C6687E27FC1705EBC56B3B2D813ABE03066E5643FE4E74','유저4','01044442222');
...
INSERT INTO TB_PET VALUES(SEQ_PET_NO.NEXTVAL, '강아지01', '강아지', '블랙푸들', 5, 'M', '착함', '기타사항없음', 1, null);
INSERT INTO TB_PET VALUES(SEQ_PET_NO.NEXTVAL, '강아지02', '강아지', '토이푸들', 6, 'M', '새침함', '기타사항없음', 1, null);
INSERT INTO TB_PET VALUES(SEQ_PET_NO.NEXTVAL, '강아지03', '강아지', '말티즈', 3, 'F', '귀여움', '기타사항없음', 1, null);
INSERT INTO TB_PET VALUES(SEQ_PET_NO.NEXTVAL, '강아지04', '강아지', '허스키', 10, 'F', '멍청함', '기타사항없음', 1, null);
INSERT INTO TB_PET VALUES(SEQ_PET_NO.NEXTVAL, '강아지05', '강아지', '웰시코기', 5, 'M', '이쁨', '기타사항없음', 1, null);
