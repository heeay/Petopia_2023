...
INSERT INTO TB_FILE VALUES (SEQ_FILE_NO.NEXTVAL, 2, 'B', 'PETOPIA_20231017120613_96817.jpeg', 'resources/board_upfiles', 1);
...
INSERT INTO TB_FILE VALUES (SEQ_FILE_NO.NEXTVAL, 9, 'I', 'PETOPIA_20231017120613_96817.jpeg', 'resources/board_upfiles', 1);
INSERT INTO TB_FILE VALUES (SEQ_FILE_NO.NEXTVAL, 10, 'J', 'PETOPIA_20231017121442_54038.png', 'resources/board_upfiles', 1);
INSERT INTO TB_FILE VALUES (SEQ_FILE_NO.NEXTVAL, 11, 'K', 'PETOPIA_20231017120613_96817.jpeg', 'resources/board_upfiles', 1);
INSERT INTO TB_FILE VALUES (SEQ_FILE_NO.NEXTVAL, 12, 'K', 'PETOPIA_20231017120613_96817.jpeg', 'resources/board_upfiles', 1);
INSERT INTO TB_FILE VALUES (SEQ_FILE_NO.NEXTVAL, 13, 'K', 'PETOPIA_20231017121442_54038.png', 'resources/board_upfiles', 1);

INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES(SEQ_BOARD_NO.NEXTVAL,'첫 게시글 제목','첫 게시글 내용 첫 게시글 내용 첫 게시글 내용',1,8,1,to_date('23/09/01','RR/MM/DD'));
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES(SEQ_BOARD_NO.NEXTVAL,'2 게시글 제목','2 게시글 내용 2 게시글 내용 2 게시글 내용',2,7,1,to_date('23/09/02','RR/MM/DD'));
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES(SEQ_BOARD_NO.NEXTVAL,'3 게시글 제목','3 게시글 내용 3 게시글 내용 3 게시글 내용',2,8,1,to_date('23/09/03','RR/MM/DD'));
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES(SEQ_BOARD_NO.NEXTVAL,'4 게시글 제목','4 게시글 내용 4 게시글 내용 4 게시글 내용',3,8,2,to_date('23/09/04','RR/MM/DD'));
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES(SEQ_BOARD_NO.NEXTVAL,'5 게시글 제목','5 게시글 내용 5 게시글 내용 5 게시글 내용',4,8,2,to_date('23/09/05','RR/MM/DD'));
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES(SEQ_BOARD_NO.NEXTVAL,'6 게시글 제목','6 게시글 내용 6 게시글 내용 6 게시글 내용',2,8,2,to_date('23/09/06','RR/MM/DD'));
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES(SEQ_BOARD_NO.NEXTVAL,'7 게시글 제목','7 게시글 내용 7 게시글 내용 7 게시글 내용',1,9,1,to_date('23/09/07','RR/MM/DD'));
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES(SEQ_BOARD_NO.NEXTVAL,'8 게시글 제목','8 게시글 내용 8 게시글 내용 8 게시글 내용',5,6,1,to_date('23/09/08','RR/MM/DD'));
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES(SEQ_BOARD_NO.NEXTVAL,'9 게시글 제목','9 게시글 내용 9 게시글 내용 9 게시글 내용',4,5,3,to_date('23/09/09','RR/MM/DD'));
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES(SEQ_BOARD_NO.NEXTVAL,'10 게시글 제목','10 게시글 내용 10 게시글 내용 10 게시글 내용',1,8,1,to_date('23/09/10','RR/MM/DD'));
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,FILE_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES( SEQ_BOARD_NO.NEXTVAL,'11 게시글 제목','11 게시글 내용 11게시글 내용 11 게시글 내용',2,10,8,1,to_date('23/09/11','RR/MM/DD'));
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,FILE_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES( SEQ_BOARD_NO.NEXTVAL,'12 게시글 제목','12 게시글 내용 12게시글 내용 12 게시글 내용',2,10,8,1,to_date('23/09/12','RR/MM/DD'));
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,FILE_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES( SEQ_BOARD_NO.NEXTVAL,'13 게시글 제목','13 게시글 내용 13게시글 내용 13 게시글 내용',2,10,8,1,to_date('23/09/13','RR/MM/DD'));
...
INSERT INTO TB_COMMENT(COMMENT_NO,COMMENT_CONTENT,USER_NO,BOARD_NO,COMMENT_GROUP)
VALUES(SEQ_COMMENT_NO.NEXTVAL,'ㄷ댓ㄱ글',1,12,SEQ_COMMENT_NO.CURRVAL);
