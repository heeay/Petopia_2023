...
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES( SEQ_BOARD_NO.NEXTVAL,'11 게시글 제목','11 게시글 내용 11게시글 내용 11 게시글 내용',2,8,1,to_date('23/09/11','RR/MM/DD'));
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES( SEQ_BOARD_NO.NEXTVAL,'12 게시글 제목','12 게시글 내용 12게시글 내용 12 게시글 내용',2,8,1,to_date('23/09/12','RR/MM/DD'));
INSERT INTO TB_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,USER_NO,CTG_NO,PET_CTG_NO,BOARD_CREATE_DATE)
VALUES( SEQ_BOARD_NO.NEXTVAL,'13 게시글 제목','13 게시글 내용 13게시글 내용 13 게시글 내용',2,8,1,to_date('23/09/13','RR/MM/DD'));
...
DELETE 
FROM TB_LIKE
WHERE BOARD_NO BETWEEN 1 AND 13;
