...
<div id="wrapper">
    ...
    <div id="reply-area">
        ...
        <div id="reply-view">
            <div id="reply-writer"><img src="" id="img-reply-writer">작성자이름</div>
            <div id="reply-content">댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용댓글내용<i class="fas fa-ellipsis-v"></i></div>
            <div id="reply-create-date"><button id="btn-reply-reply">답글쓰기</button></div>
        </div>
    </div>

    <div id="pasing-area">
        <div class="btn-pasing">이전글</div>
        <div class="btn-pasing">다음글</div>
    </div>
