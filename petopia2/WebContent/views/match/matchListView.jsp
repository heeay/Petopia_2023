...
#category li:not (#category li:last-child ){
	margin-bottom: 10px;
}
			...
			<div id="wrapper">
					...
					<div id="search-help">
						<div id="search-bar">
							<form action="main.pb" method="get" id="search-form">
								...
								<i id="search-icon" class="fas fa-search"><button
										type="submit" id="search-btn"></button></i>
							</form>
						</div>
                ...
                $(function(){
                    $('#search-icon').click(function(){
						...
						<div id="search-radio">
							<input type="radio" name="">제목 <input type="radio"
								name="">작성자
						</div>
